...
document.querySelector('.tariffs-open').addEventListener('click',()=>{
    ...
    if(document.querySelector('.tariffs-open').classList.contains('active')){
        ...
        smoothHeightTransition(document.querySelector('.tariffs-list__items'), permanentHeught, 400, true);
    }else{
        ...
        smoothHeightTransition(document.querySelector('.tariffs-list__items'), offsetHeight, 400, false);
    }

})

function smoothHeightTransition(element, targetHeight, duration, increase) {
